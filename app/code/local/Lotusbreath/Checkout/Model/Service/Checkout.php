...
class Lotusbreath_Checkout_Model_Service_Checkout extends Varien_Object{
    ...
    public function submitOrder()
    {
        try {
            ...
            //save shop id
            if ($this->getRequest()->getPost('shop_id')) {
                $shopId = Mage::getModel('zodiya_affiliates/affiliates')
                    ->loadByShopName($this->getRequest()->getPost('shop_id'));
                Mage::getSingleton('core/session')->setShopId($shopId);
            }
