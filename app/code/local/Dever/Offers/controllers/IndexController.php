            ...
            if ($post) {
                ...
                if ($model->save()) {
                    ...
                    Mage::getSingleton('core/session')->addSuccess(
                        Mage::helper('dever_offers')->__('<h4>Thanks for registration. Promo code will be shared in sms shortly.</h4><p>You may not receive the message when DND service is activated in your phone. For any assistance please contact us at: +91-9072345014.</p>')
                    );
                }
            }
        } catch (Exception $e) {
