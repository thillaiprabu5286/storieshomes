...
class TM_AjaxLayeredNavigation_Block_Adminhtml_Range extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        ...
        $this->_addButton('refresh_data', array(
            'label'     => Mage::helper('ajaxlayerednavigation')->__('Load Category'),
            'onclick'   =>  "
