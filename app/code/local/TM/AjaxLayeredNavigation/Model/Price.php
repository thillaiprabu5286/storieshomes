...
class TM_AjaxLayeredNavigation_Model_Price extends Mage_Catalog_Model_Layer_Filter_Price
{
    ...
    {
        return $this->_resource = Mage::getResourceModel('ajaxlayerednavigation/price');
    }
    ...
    public function apply(Zend_Controller_Request_Abstract $request, $filterBlock)
    {
        ...
        foreach ($filterParams as $priceParam) {
            ...
            $this->setData('max_price_int', $to);
            $this->setData('min_price_int', empty($from) ? 0 : $from);
            $this->setData('max_range_int', $to);
            $this->setData('min_range_int', empty($from) ? 0 : $from);
        }
