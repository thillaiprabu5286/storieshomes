...
class Themevast_Blog_Manage_BlogController extends Mage_Adminhtml_Controller_Action
{
        ...
        if ($data = $this->getRequest()->getPost()) {
            ...
            if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != '') {
                try {   
                    ...
                    $path = Mage::getBaseDir('media') . DS . 'themevast' . DS .'blog'. DS;
                    $result = $uploader->save($path, $_FILES['image']['name'] );
                    
                    //this way the name is saved in DB
                    $data['image'] = 'themevast/blog/'. $result['file'];
                } catch (Exception $e) {
