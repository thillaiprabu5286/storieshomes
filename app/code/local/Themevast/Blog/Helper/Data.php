...
class Themevast_Blog_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    public function getSlideCfg($cfg=null) 
    {
        $config = Mage::getStoreConfig('blog/slide');
    ...
    {
        return Mage::getStoreConfig('blog/blog/enabled') && $this->extensionEnabled('Themevast_Blog');
    }
