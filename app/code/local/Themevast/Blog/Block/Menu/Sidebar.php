...
class Themevast_Blog_Block_Menu_Sidebar extends Themevast_Blog_Block_Abstract
{
    ...
    protected function _toHtml()
    {
        if (self::$_helper->getEnabled()) {
            ...
            $isBlogPage = Mage::app()->getRequest()->getModuleName() == Themevast_Blog_Helper_Data::DEFAULT_ROOT;
