<?php
class Themevast_Testimonial_FormController extends Mage_Core_Controller_Front_Action {
	...
	public function captchaAction() {
		require_once(Mage::getBaseDir('lib').DS.'themevast'.DS.'captcha'.DS.'class.simplecaptcha.php');
		//Background Image
		$config['BackgroundImage'] = Mage::getBaseDir('lib').DS.'themevast'.DS.'captcha'. DS . "white.png";
		...
		//text font style
		$config['Font']= Mage::getBaseDir('lib').DS.'themevast'.DS.'captcha'. DS . "ARLRDBD.TTF";
	...
	public function save() {
		...
		if ($post) {
			...
			if(isset($_FILES['avatar']['name']) && $_FILES['avatar']['name'] != '')
			{
				try
				{
					$path = Mage::getBaseDir().DS.'media/themevast/avatar'.DS;
