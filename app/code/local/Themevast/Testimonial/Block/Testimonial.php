<?php
class Themevast_Testimonial_Block_Testimonial extends Mage_Core_Block_Template {
	...
	public function _prepareLayout() {
        ...
        if(Mage::getStoreConfig('testimonial/general/enable_testimonial_paging')){
            $fieldPerPage = Mage::getStoreConfig('testimonial/general/divide_page');
