<?php
class Themevast_Saleproduct_Block_Saleproduct extends Mage_Catalog_Block_Product_Abstract
{
	...
	{
		if(!$this->_config) $this->_config = Mage::getStoreConfig('saleproduct/general'); 
	}
