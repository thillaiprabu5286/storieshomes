<?php
class Themevast_Themevast_Helper_Data extends Mage_Core_Helper_Abstract
{
   ...
   public function getContentFromXmlFile($xmlPath = NULL, $node= NULL) {
        ...
        if ($statickBlockData) return $statickBlockData;
        return array();
    } 
    
   public function getStaticBlockData() {
        $xmlPath = Mage::getBaseDir('code') . '/local/Themevast/Themevast/etc/import/blocks.xml';
    ...
    public function getCmsPageData() {
        ...
        $xmlPath = Mage::getBaseDir('code') . '/local/Themevast/Themevast/etc/import/pages.xml';
    ...
    public function getNodeDataFromBlock($node = 'identifier', $blocks = array()) {
        ...
        if($array_identifier) return $array_identifier;
        return array();
