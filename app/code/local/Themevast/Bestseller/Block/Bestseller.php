<?php
class Themevast_Bestseller_Block_Bestseller extends Mage_Catalog_Block_Product_Abstract
{
	...
	{
		if(!$this->_config) $this->_config = Mage::getStoreConfig('bestseller/general'); 
	}
