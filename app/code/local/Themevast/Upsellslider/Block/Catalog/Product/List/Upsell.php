<?php
class Themevast_Upsellslider_Block_Catalog_Product_List_Upsell extends Mage_Catalog_Block_Product_List_Upsell
{
    ...
    {
        return 'themevast/upsellslider/upsellslider.phtml';
    }
