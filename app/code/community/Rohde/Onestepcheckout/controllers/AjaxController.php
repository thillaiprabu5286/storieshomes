 ...
 */
class Rohde_Onestepcheckout_AjaxController extends Mage_Checkout_Controller_Action {

    /**
     * @return Rohde_Onestepcheckout_AjaxController|Mage_Core_Controller_Front_Action
     */
    ...
    public function customerForgotPasswordAction() {
        ...
        $email = (string) trim($this->getRequest()->getPost('email'));
        if ($email) {
    ...
    public function saveAddressAction() {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            $useBillingForShipping = isset($data['use_for_shipping']) ? true : false;
            if (!$useBillingForShipping) { // don't use billing address for shipping
    ...
    /**
     * @return Rohde_Onestepcheckout_Model_Updater
     */
    ...
    /**
     * @return Rohde_Onestepcheckout_AjaxController
     */
    ...
    private function _isEmailRegistered($email) {
        ...
        $model->setWebsiteId(Mage::app()->getStore()->getWebsiteId())->loadByEmail(trim($email));
        if ($model->getId() == NULL) {
            return false;
        }
        return true;
    ...
    public function check_emailAction() {
        ...
        $email = trim($this->getRequest()->getPost('email', false));
