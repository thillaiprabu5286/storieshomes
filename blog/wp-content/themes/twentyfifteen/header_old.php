			...
			<div class="site-branding">
				<?php
					if ( is_front_page() && is_home() ) : ?>
						<h1 class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><!-- <?php bloginfo( 'name' ); ?>--><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/stories-logo.png" ></a></h1>
					<?php else : ?>
