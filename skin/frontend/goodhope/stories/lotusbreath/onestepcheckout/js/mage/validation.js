...
(function($) {
    ...
    var rules = {
        ...
        "validate-cmobile": [
            function() {
                var conf = $('#confirm_telephone').length > 0 ? $('#confirm_telephone') : $($('.validate-cmobile')[0]);
                var pass = false;
                if ($('#telephone')) {
                    pass = $('#telephone');
                }
                var passwordElements = $('.validate-mobile');
                for (var i = 0; i < passwordElements.length; i++) {
                    var passwordElement = $(passwordElements[i]);
                    if (passwordElement.closest('form').attr('id') === conf.closest('form').attr('id')) {
                        pass = passwordElement;
            ...
            'Please make sure your mobile number matches.'
        ],
        "validate-identifier": [
            function(v) {
