...
OnestepcheckoutForm.prototype = {
    initialize: function(config) {
        ...
        this.invalidClassName = config.invalidClassName;
        this.invalidButtonText = config.invalidButtonText;
        this.defaultButtonText = config.defaultButtonText;
    ...
    placeOrder: function() {
        if (this.validate()) {
            ...
            this.showInvalidTextOnPlaceOrderButton();
        }
    },
    ...
    showInvalidTextOnPlaceOrderButton: function() {
        this.placeOrderButton.addClassName(this.invalidClassName);
        this.placeOrderButton.update(this.invalidButtonText);
        var that = this;
        this.hideInvalidTextOnPlaceOrderButton.delay(2, that);
    },

    hideInvalidTextOnPlaceOrderButton: function(that) {
        that.placeOrderButton.removeClassName(that.invalidClassName);
        that.placeOrderButton.update(that.defaultButtonText);
    },
