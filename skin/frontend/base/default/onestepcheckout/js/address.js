...
OnestepcheckoutAddress.prototype = {
    initialize: function(config) {
        ...
        this.billing.addressClearElementsIds = config.billing.addressClearElementsIds;
        ...
        this.shipping.addressClearElementsIds = config.shipping.addressClearElementsIds;
    ...
    initObservers: function() {
        ...
        if (this.billing.countrySelectElement) {
            ...
            this.billing.countrySelectElement.observe('change',  this.onAddressChanged.bind(this));
        }
        ...
        if (this.shipping.countrySelectElement) {
            ...
            this.shipping.countrySelectElement.observe('change', this.onAddressChanged.bind(this));
        }
    ...
    clearBillingAddress: function() {
        this.billing.addressClearElementsIds.each(function(element){
            if($(element)) {
                $(element).value = '';
            }
        });
    ...
    clearShippingAddress: function() {
        this.shipping.addressClearElementsIds.each(function(element){
            if($(element)) {
                $(element).value = '';
            }
        });
